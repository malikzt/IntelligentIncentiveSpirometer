...
void loop() {
  ...
  volume= (distance* (4000/150)); //volume= distance * M_PI * 8.5; //volume of cylinder in mL  volume= 4000-volume;
  //if (millis() - max_Time < 5000) {
